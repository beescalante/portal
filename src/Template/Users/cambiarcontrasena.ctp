                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <a class="font-weight-bolder font-size-h7 text-dark-75 text-hover-primary">
                                    <?php echo $estudiante->nombre.' '.$estudiante->apellido1.' '.$estudiante->apellido2; ?>
                                </a>
                                <div class="text-muted">
                                    <?php echo $estudiante->sede->nombre; ?>
                                </div>
                                <?php if($estudiante->conape==1): ?>
                                    <div class="mt-2">
                                        <p class="bg-primary text-white py-2 px-4">Beneficiario CONAPE</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="py-9">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="text-muted"><?php echo $estudiante->emailu; ?></span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <span class="font-weight-bold mr-2">Teléfono:</span>
                                <span class="text-muted"><?php echo $estudiante->telefono; ?></span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            <div class="navi-item mb-2">
                                <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'miperfil']) ?>" class="navi-link py-4 ">
                            ...
                            <div class="navi-item mb-2">
                                <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'cambiarcontrasena']) ?>" class="navi-link py-4 active">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Contraseña</h3>
                            <span class="text-muted font-weight-bold font-size-sm mt-1">Cambiar mi contraseña</span>
                        </div>
