                        ...
                        <table class="table1" width="480" align="center" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <td align="center">
                                    <table align="center" border="0" cellspacing="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <table class="button_bg_color_93c054" bgcolor="#93c054" width="120" height="40" align="left" border="0" cellpadding="0" cellspacing="0" style="border-radius:5px; border-collapse: separate">
                                                    <tr>
                            ...
                            <tr>
                                <td align="center" mc:edit="text102" class="text_color_c6c6c6" style="line-height: 1.8;color: #605d5d; font-size: 12px; font-weight: 400; font-family: 'Open Sans', Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                    <div class="editable-text">
                                        <span class="text_container"><br>Si usted no tiene acceso al Portal Acad&eacute;mico, le sugerimos intentar recuperar su contrase&ntilde;a con su correo institucional si el portal le indica que su correo no se encuentra registrado por favor comun&iacute;quese con el equipo de soporte o personal de plataforma de su sede.</span>
                                    </div>
                                </td>
                            </tr><!-- END email details -->
