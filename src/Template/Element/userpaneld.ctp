...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    ...
                    <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'logout']) ?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Cerrar</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
    ...
    <div class="navi navi-spacer-x-0 p-0">
        <!--begin::Item-->
        <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'miperfild']) ?>" class="navi-item">
            <div class="navi-link">
        ...
        <!--end:Item-->
        <!--begin::Item-->
        <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'cambiarcontrasenad']) ?>" class="navi-item">
            <div class="navi-link">
                <div class="symbol symbol-40 bg-light mr-3">
                    <div class="symbol-label">
