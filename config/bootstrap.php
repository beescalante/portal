 ...
 */
ini_set('intl.default_locale', 'es-US');
// ...
Cake\I18n\Time::setDefaultLocale('es_ES');
Cake\I18n\Time::setToStringFormat('hh:mm a');
Cake\I18n\FrozenTime::setToStringFormat('hh:mm a');
